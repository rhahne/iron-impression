      ...
      <!-- Intro text -->
        ...
        >
          <tr>
            ...
            >
              <a
                 href="http://localhost:3000/users/createAccount/${emailHash}" style="background:#F45E43;color:#ffffff;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;font-weight:normal;line-height:120%;Margin:0;text-decoration:none;text-transform:none;" target="_blank"
              >
                Get Access!
              </a>
            </td>
